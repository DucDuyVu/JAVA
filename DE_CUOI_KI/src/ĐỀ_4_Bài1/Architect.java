...
public class Architect extends Staff {
    ...
    */
	public String getExpertise() {
		 ...
		 */
		String mien = super.getEmail().substring(super.getEmail().indexOf('@')+1 , super.getEmail().indexOf('.'));
		if(mien.equals("advl")) {
			return "Adjacent villa";
		}
		else if(mien.equals("apm")) {
			return "Apartment";
		}
		return null;
	}
	...
	*/
	...
	public double getSalary() {
	    ...
	    */
		return super.getBasicSalary() + (no_constructions + getSeniority()) * 300000 + getReward();
	}
